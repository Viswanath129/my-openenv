...
class Observation(BaseModel):
    ...
    error_trace: Optional[str] = Field(
        default=None,
        description="Specific error messages generated by malformed tool calls or invalid state transitions",
    )
    step_feedback: Optional[str] = Field(
        default=None,
        description="Micro-rewards, qualitative hints, or penalties generated immediately after the action",
    )
    html_observation: Optional[str] = Field(
        default=None,
        description="Visual representation of the inbox state as an HTML table for multi-modal agents",
    )
